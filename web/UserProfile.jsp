<%-- 
    ...
    Created on : Jan 2, 2018, 1:34:22 AM
    ...
    <body class="landing">
        <div id="page-wrapper">
            ...
            <section id="banner">
                ...
                <form method="post" action="UpdateProfileServlet" style=" width: 100%;">
                                            ...
                                            <tr>
                                                <td><b><p>Username</p>
                                                        <td><b><input type="text" name="username" id="username" value="${sessionScope.memberprofile.getUsername()}" readonly />
                                                                ...
                                                                <tr>
                                                                    <td><b><p>Email</p>
                                                                            <td><b><input type="text" name="email" id="email" value="${sessionScope.memberprofile.getEmail()}"/>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td><b><p>Password</p>
                                                                                                <td><b><input type="text" name="password" id="password" value="${sessionScope.memberprofile.getPassword()}"/>
                                                                                                        ...
                                                                                                        <input class="button alt icon fa-check" style ="background-color: white;color: black; border: 2px solid #4CAF50; " type="submit" class="button" value="Update" onclick="myFunction()"/>
