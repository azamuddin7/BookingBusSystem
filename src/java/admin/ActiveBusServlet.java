 ...
 * @author Sufi
 */
@WebServlet(name = "ActiveBusServlet", urlPatterns = {"/ActiveBusServlet"})
public class ActiveBusServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       HttpSession session = request.getSession();
        ...
        String sqlUpdate = "UPDATE setbus SET status = 'active' WHERE id = ?"; 
