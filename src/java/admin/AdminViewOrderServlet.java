...
public class AdminViewOrderServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //double price;
        //int bookid, id;
        String username, pickup, dropoff, bookid, id, price;
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            */
            ...
            String sqlSelectReq = "SELECT * FROM requestbus";
           
            PreparedStatement psSelectReqStatement = con.prepareStatement(sqlSelectReq);
            ResultSet rs = psSelectReqStatement.executeQuery();
            ...
            while(rs.next() ){
                ...
                //link to table setbus
                String sqlSelectSet = "SELECT * FROM setbus WHERE id=?";
                PreparedStatement psSelectSetStatement = con.prepareStatement(sqlSelectSet);
                psSelectSetStatement.setString(1, id);
                ResultSet rs2 = psSelectSetStatement.executeQuery();
                ...
                //set
               // set.setPickup(pickup);
                //set.setDropoff(dropoff);
                //set.setPrice(price);
                
                //put req into arraylist
                booking.add(req);
