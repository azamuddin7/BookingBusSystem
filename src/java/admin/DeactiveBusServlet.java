 ...
 * @author Sufi
 */
@WebServlet(name = "DeactiveBusServlet", urlPatterns = {"/DeactiveBusServlet"})
public class DeactiveBusServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String sqlUpdate = "UPDATE setbus SET status = 'deactive' WHERE id = ?"; 
